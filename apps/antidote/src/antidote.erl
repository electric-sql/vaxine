...
-spec get_log_operations([{bound_object(), snapshot_time()}]) ->
    {ok, [[{non_neg_integer(), clocksi_payload()}]]} | {error, reason()}.
...
-spec update_objects(snapshot_time() | ignore, txn_properties(), [
